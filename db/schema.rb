...
ActiveRecord::Schema.define(version: 20150827035155) do
  ...
  create_table "practice_interviews", force: :cascade do |t|
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "response_lengths", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
